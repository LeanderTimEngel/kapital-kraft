  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      <div className="container mx-auto px-4 pt-24 md:pt-32 pb-16">
        <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-8 text-center font-serif">Über KapitalKraft</h1>
        <div className="max-w-3xl mx-auto">
          <Image
            src="/images/team.jpg"
            alt="KapitalKraft Team"
            width={800}
            height={400}
          ...
          <div className="space-y-6 text-gray-700">
            <p>
              KapitalKraft ist die führende Jobbörse, die Top-Talente mit spannenden Möglichkeiten im Venture-Capital- und Startup-Ökosystem verbindet. Gegründet im Jahr 2023, ist es unsere Mission, die Lücke zwischen ambitionierten Fachkräften und innovativen Unternehmen zu schließen, die die Zukunft gestalten.
            </p>
            <p>
            ...
            <p>
              Bei KapitalKraft glauben wir an die Kraft der Innovation und den Einfluss, den die richtigen Talente auf aufstrebende Unternehmen haben können. Unser Team widmet sich der Förderung von Verbindungen, die Wachstum und Erfolg im Venture-Capital-Ökosystem vorantreiben.
            </p>
            <p>
